...
/**
 * Block activity_notifier is defined here.
 *
 * @package     block_activity_notifier
 * @copyright   Hassan Hassanzadeh Aliabadi<h.h.aliabadi@gmail.com>
...
class block_activity_notifier extends block_list {
    function init() {
        $this->title = get_string('pluginname', 'block_activity_notifier');
    }
